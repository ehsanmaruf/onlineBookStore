...
<!-- book name input field -->
            <div class="form-group mt-1">
               <label for="bookName" style="color:black;">Enter title of the book!</label>
                <input class="form-control" type="text" name="bookName" id="bookName"  onfocus="this.placeholder=''" onblur="this.placeholder='Enter name of the book!'" placeholder="Enter the book." required="" style=" color: black;">
            </div>
...
<!-- book price input field -->
            <div class="form-group mt-1">
               <label for="bookPrice" style="color:black">Enter price of the book!</label>
                <input class="form-control" type="number" name="bookPrice" id="bookPrice"  onfocus="this.placeholder=''" onblur="this.placeholder='Enter price of the book!'" placeholder="Enter the book's price." required="" style=" color: black;">
            </div>
<!-- book image field -->
            <div class="form-group">
...
<!-- book stock input field -->
            <div class="form-group mt-1">
               <label for="bookStock" style="color:black">Enter stock of the book!</label>
                <input class="form-control" type="number" name="bookStock" id="bookStock"  onfocus="this.placeholder=''" onblur="this.placeholder='Enter Stock of the book!'" placeholder="Enter the book's stock." required="" style=" color: black;">
            </div>
<!-- book published year input field -->
<div class="form-group mt-1">
               <label for="bookPublish" style="color:black">Enter published year of the book!</label>
                <input class="form-control" type="number" name="bookPublish" id="bookPublish"  onfocus="this.placeholder=''" onblur="this.placeholder='Enter publish year of the book!'" placeholder="Enter the book's publish year." required="" style=" color: black;">
            </div>
            <button type="submit" class="btn btn-success col-md-5" name="add_book" >Add New Book</button>
